...
const DeviceManagementHeader = () => {
  return (
   <div className="flex items-center justify-between w-full px-4 py-2 bg-white border border-[#F4F4F4] rounded-lg shadow-sm mb-2">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-base font-bold text-[#1A1D1F] tracking-tight">
