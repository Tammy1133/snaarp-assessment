...
export const StorageCard = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-[20px] border border-gray-100 shadow-sm xl:max-w-[700px] flex flex-col font-sans">
    ...
    <div className="flex items-center gap-2 mb-6">
      ...
      <div className="flex flex-col gap-2 items-start">
        <div className="bg-white border-x-2  border-[#FFB100] p-4 rounded-xl shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05)] relative mb-8">
            ...
            <div className="flex items-start gap-3 pl-2">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#4A4A4A] leading-tight">
          ...
          <div className="grid grid-cols-3 gap-x-2 gap-y-5 px-2">
            {legendItems.map((item) => (
              <div key={item.label} className="flex items-center gap-2">
                <div className="w-4 h-4 rounded-[4px] shrink-0" style={{ backgroundColor: item.color }} />
                <span className="text-[13px] text-[#1A1D1F] whitespace-nowrap">{item.label}</span>
              </div>
            ))}
          </div>

          <div className=" flex justify-end w-full mt-2">
            <button className="border border-[#4F46E5] border-opacity-40 text-[#4F46E5] px-6 py-2.5 rounded-xl flex items-center gap-2 text-[14px] font-medium hover:bg-indigo-50 transition-colors">
